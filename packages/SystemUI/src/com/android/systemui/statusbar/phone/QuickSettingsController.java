...
import com.android.systemui.quicksettings.ToggleDuiTile;
...
public class QuickSettingsController {
    ...
    void loadTiles() {
        ...
        for (String tile : tiles.split("\\|")) {
            ...
            } else if (tile.equals(TILE_DUI)) {
                qs = new ToggleDuiTile(mContext, inflater, mContainerView, this, mHandler);
